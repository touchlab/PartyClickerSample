...
extern "C" JNIEXPORT void JNICALL Java_net_sqlcipher_database_SQLiteCompiledSql_native_1compile(JNIEnv* env, jobject object, jstring sqlString)
{
    native_compile(env, object, sqlString);
}
...
extern "C" JNIEXPORT void JNICALL Java_net_sqlcipher_database_SQLiteCompiledSql_native_1finalize(JNIEnv* env, jobject object)
{
    native_finalize(env, object);
}
