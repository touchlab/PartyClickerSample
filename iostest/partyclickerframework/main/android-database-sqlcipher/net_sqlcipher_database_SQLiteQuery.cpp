...
extern "C" JNIEXPORT jint JNICALL Java_net_sqlcipher_database_SQLiteQuery_native_1fill_1window(JNIEnv* env, jobject object, jobject javaWindow,
                                                                                         jint startPos, jint offsetParam, jint maxRead, jint lastPos)
{
return native_fill_window(env, object, javaWindow,
                                                                                         startPos, offsetParam, maxRead, lastPos);
}
...
extern "C" JNIEXPORT jint JNICALL Java_net_sqlcipher_database_SQLiteQuery_native_1column_1count(JNIEnv* env, jobject object)
{
return native_column_count(env, object);
}
...
extern "C" JNIEXPORT jstring JNICALL Java_net_sqlcipher_database_SQLiteQuery_native_1column_1name(JNIEnv* env, jobject object, jint columnIndex)
{
return native_column_name(env, object, columnIndex);
}
