...
- (void)setUp {
  ...
  JreStrongAssignAndConsume(&partyPresenter_, new_PPPartyPresenter_initWithInt_([((JavaLangLong *) nil_chk(((PDParty *) nil_chk(party_))->id__)) intValue]));
...
- (void)init__ {
  ...
  OrgJunitAssert_assertEqualsWithId_withId_(((PDParty *) nil_chk(party_))->id__, ((PDParty *) nil_chk([((PPPartyPresenter *) nil_chk(partyPresenter_)) getParty]))->id__);
...
- (void)addPerson {
  ...
  OrgJunitAssert_assertEqualsWithLong_withLong_(3, [((id<PDDataProvider>) nil_chk(dataProvider_)) countCurrentPartyWithInt:[((JavaLangLong *) nil_chk(((PDParty *) nil_chk(party_))->id__)) intValue]]);
...
- (void)removePerson {
  ...
  OrgJunitAssert_assertEqualsWithLong_withLong_(2, [((id<PDDataProvider>) nil_chk(dataProvider_)) countCurrentPartyWithInt:[((JavaLangLong *) nil_chk(((PDParty *) nil_chk(party_))->id__)) intValue]]);
  [((id<PPPartyPresenter_UiInterface>) nil_chk(OrgMockitoMockito_verifyWithId_withOrgMockitoVerificationVerificationMode_(uiInterface_, OrgMockitoMockito_atLeastOnce()))) updateUi];
}
