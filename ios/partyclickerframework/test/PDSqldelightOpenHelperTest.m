...
__attribute__((unused)) static IOSObjectArray *PDSqldelightOpenHelperTest__Annotations$1();

__attribute__((unused)) static IOSObjectArray *PDSqldelightOpenHelperTest__Annotations$2();

__attribute__((unused)) static IOSObjectArray *PDSqldelightOpenHelperTest__Annotations$3();

__attribute__((unused)) static IOSObjectArray *PDSqldelightOpenHelperTest__Annotations$4();

__attribute__((unused)) static IOSObjectArray *PDSqldelightOpenHelperTest__Annotations$5();

__attribute__((unused)) static IOSObjectArray *PDSqldelightOpenHelperTest__Annotations$6();

__attribute__((unused)) static IOSObjectArray *PDSqldelightOpenHelperTest__Annotations$7();

__attribute__((unused)) static IOSObjectArray *PDSqldelightOpenHelperTest__Annotations$8();

__attribute__((unused)) static IOSObjectArray *PDSqldelightOpenHelperTest__Annotations$9();

@implementation PDSqldelightOpenHelperTest

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  PDSqldelightOpenHelperTest_init(self);
  return self;
}
...
- (void)setUp {
  ...
  [((id<PTTestComponent>) nil_chk(testComponent)) injectWithPDSqldelightOpenHelperTest:self];
  JreStrongAssignAndConsume(&databaseHelper_, new_PDSqldelightOpenHelper_initWithAndroidContentContext_(application_));
...
- (void)allParties {
  OrgJunitAssert_assertEqualsWithLong_withLong_(1, [((id<JavaUtilList>) nil_chk([((PDSqldelightOpenHelper *) nil_chk(databaseHelper_)) allParties])) size]);
  [((PDSqldelightOpenHelper *) nil_chk(databaseHelper_)) createPartyWithNSString:@"asdf"];
  [((PDSqldelightOpenHelper *) nil_chk(databaseHelper_)) createPartyWithNSString:@"qwert"];
  OrgJunitAssert_assertEqualsWithLong_withLong_(3, [((id<JavaUtilList>) nil_chk([((PDSqldelightOpenHelper *) nil_chk(databaseHelper_)) allParties])) size]);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  return &_PDSqldelightOpenHelperTest;
}

@end

void PDSqldelightOpenHelperTest_init(PDSqldelightOpenHelperTest *self) {
  NSObject_init(self);
}

PDSqldelightOpenHelperTest *new_PDSqldelightOpenHelperTest_init() {
  J2OBJC_NEW_IMPL(PDSqldelightOpenHelperTest, init)
}

PDSqldelightOpenHelperTest *create_PDSqldelightOpenHelperTest_init() {
  J2OBJC_CREATE_IMPL(PDSqldelightOpenHelperTest, init)
}

IOSObjectArray *PDSqldelightOpenHelperTest__Annotations$0() {
  return [IOSObjectArray arrayWithObjects:(id[]){ create_OrgJunitBefore() } count:1 type:JavaLangAnnotationAnnotation_class_()];
}

IOSObjectArray *PDSqldelightOpenHelperTest__Annotations$1() {
  return [IOSObjectArray arrayWithObjects:(id[]){ create_OrgJunitTest(OrgJunitTest_None_class_(), 0) } count:1 type:JavaLangAnnotationAnnotation_class_()];
}

IOSObjectArray *PDSqldelightOpenHelperTest__Annotations$2() {
  return [IOSObjectArray arrayWithObjects:(id[]){ create_OrgJunitTest(OrgJunitTest_None_class_(), 0) } count:1 type:JavaLangAnnotationAnnotation_class_()];
}

IOSObjectArray *PDSqldelightOpenHelperTest__Annotations$3() {
  return [IOSObjectArray arrayWithObjects:(id[]){ create_OrgJunitTest(OrgJunitTest_None_class_(), 0) } count:1 type:JavaLangAnnotationAnnotation_class_()];
}

IOSObjectArray *PDSqldelightOpenHelperTest__Annotations$4() {
  return [IOSObjectArray arrayWithObjects:(id[]){ create_OrgJunitTest(OrgJunitTest_None_class_(), 0) } count:1 type:JavaLangAnnotationAnnotation_class_()];
}

IOSObjectArray *PDSqldelightOpenHelperTest__Annotations$5() {
  return [IOSObjectArray arrayWithObjects:(id[]){ create_OrgJunitTest(OrgJunitTest_None_class_(), 0) } count:1 type:JavaLangAnnotationAnnotation_class_()];
}

IOSObjectArray *PDSqldelightOpenHelperTest__Annotations$6() {
  return [IOSObjectArray arrayWithObjects:(id[]){ create_OrgJunitTest(OrgJunitTest_None_class_(), 0) } count:1 type:JavaLangAnnotationAnnotation_class_()];
}

IOSObjectArray *PDSqldelightOpenHelperTest__Annotations$7() {
  return [IOSObjectArray arrayWithObjects:(id[]){ create_OrgJunitTest(OrgJunitTest_None_class_(), 0) } count:1 type:JavaLangAnnotationAnnotation_class_()];
}

IOSObjectArray *PDSqldelightOpenHelperTest__Annotations$8() {
  return [IOSObjectArray arrayWithObjects:(id[]){ create_JavaxInjectInject() } count:1 type:JavaLangAnnotationAnnotation_class_()];
}

IOSObjectArray *PDSqldelightOpenHelperTest__Annotations$9() {
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(PDSqldelightOpenHelperTest)
