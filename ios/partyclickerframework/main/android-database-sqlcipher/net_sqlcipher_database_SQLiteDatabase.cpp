...
namespace sqlcipher {
  ...
  extern "C" JNIEXPORT jint JNICALL Java_net_sqlcipher_database_SQLiteDatabase_native_1status(JNIEnv* env, jobject object, jint operation, jboolean reset)
  {
  return native_status(env, object, operation, reset);
  }
 ...
 extern "C" JNIEXPORT void JNICALL Java_net_sqlcipher_database_SQLiteDatabase_key(JNIEnv* env, jobject object, jbyteArray jKey) {
  native_key(env, object, jKey);
  }

  extern "C" JNIEXPORT void JNICALL Java_net_sqlcipher_database_SQLiteDatabase_native_1key(JNIEnv* env, jobject object, jbyteArray jKey) {
    native_key(env, object, jKey);
    }
...
extern "C" JNIEXPORT void JNICALL Java_net_sqlcipher_database_SQLiteDatabase_rekey(JNIEnv* env, jobject object, jbyteArray jKey) {
native_rekey(env, object, jKey);
}
extern "C" JNIEXPORT void JNICALL Java_net_sqlcipher_database_SQLiteDatabase_native_1rekey(JNIEnv* env, jobject object, jbyteArray jKey) {
native_rekey(env, object, jKey);
}
  void native_key_mutf8(JNIEnv* env, jobject object, jcharArray jKey) {
    ...
    const char* password = env->GetStringUTFChars(key, NULL);
  ...
  extern "C" JNIEXPORT void JNICALL Java_net_sqlcipher_database_SQLiteDatabase_key_1mutf8(JNIEnv* env, jobject object, jcharArray jKey) {
  native_key_mutf8(env, object, jKey);
  }
  ...
  extern "C" JNIEXPORT void JNICALL Java_net_sqlcipher_database_SQLiteDatabase_native_1rawExecSQL(JNIEnv* env, jobject object, jstring sql)
  {
  native_rawExecSQL(env, object, sql);
  }
...
extern "C" JNIEXPORT void JNICALL Java_net_sqlcipher_database_SQLiteDatabase_dbopen(JNIEnv* env, jobject object, jstring pathString, jint flags)
{
    dbopen(env, object, pathString, flags);
}
  ...
  extern "C" JNIEXPORT void JNICALL Java_net_sqlcipher_database_SQLiteDatabase_enableSqlTracing(JNIEnv* env, jobject object, jstring databaseName)
  {
  enableSqlTracing(env, object, databaseName);
  }
  ...
  extern "C" JNIEXPORT void JNICALL Java_net_sqlcipher_database_SQLiteDatabase_enableSqlProfiling(JNIEnv* env, jobject object, jstring databaseName)
  {
  enableSqlProfiling(env, object, databaseName);
  }


  extern "C" JNIEXPORT void JNICALL Java_net_sqlcipher_database_SQLiteDatabase_dbclose(JNIEnv* env, jobject object)
  {
  sqlite3 * handle = (sqlite3 *)env->GetLongField(object, offset_db_handle);
  ...
  extern "C" JNIEXPORT void JNICALL Java_net_sqlcipher_database_SQLiteDatabase_native_1execSQL(JNIEnv* env, jobject object, jstring sqlString)
  {
  native_execSQL(env, object, sqlString);
  }
  ...
  extern "C" JNIEXPORT jlong JNICALL Java_net_sqlcipher_database_SQLiteDatabase_lastInsertRow(JNIEnv* env, jobject object)
  {
  return lastInsertRow(env, object);
  }
  ...
  extern "C" JNIEXPORT jint JNICALL Java_net_sqlcipher_database_SQLiteDatabase_lastChangeCount(JNIEnv* env, jobject object)
  {
  return lastChangeCount(env, object);
  }
  ...
  extern "C" JNIEXPORT jint JNICALL Java_net_sqlcipher_database_SQLiteDatabase_native_1getDbLookaside(JNIEnv* env, jobject object)
  {
  return native_getDbLookaside(env, object);
  }
  ...
  extern "C" JNIEXPORT jint JNICALL Java_net_sqlcipher_database_SQLiteDatabase_releaseMemory(JNIEnv *env, jobject clazz)
  {
  return native_releaseMemory(env, clazz);
  }
  ...
  extern "C" JNIEXPORT void JNICALL Java_net_sqlcipher_database_SQLiteDatabase_nativeInit(JNIEnv* env, jclass)
  {
      JavaVM *g_VM;
      env->GetJavaVM(&g_VM);
